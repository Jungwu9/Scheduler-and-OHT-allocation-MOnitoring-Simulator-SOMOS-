...
class JSSPConfig:
    ...
    planned_gantt_csv: str = _repo("gantt_final", "planned_gantt.csv")   # the fixed plan, replayed as-is
    step_info_path:    str = _repo("ProcessStepInfo.txt")  # for realized-proc sampling (Normal avg/sd/min)
